...
impl DocumentRepository for SqliteDocumentRepository {
    ...
    async fn get_folder(&self, pool: &SqlitePool, id: Uuid) -> Result<DocumentFolder> {
        ...
        Ok(DocumentFolder {
            base: erp_core::BaseEntity {
                ...
                created_by: erp_core::parse_uuid_opt(row.try_get::<Option<&str>, _>("created_by")?, "created_by")?,
                updated_by: erp_core::parse_uuid_opt(row.try_get::<Option<&str>, _>("updated_by")?, "updated_by")?,
            },
            name: row.try_get::<&str, _>("name")?.to_string(),
            parent_id: erp_core::parse_uuid_opt(row.try_get::<Option<&str>, _>("parent_id")?, "parent_id")?,
    ...
    async fn get_document(&self, pool: &SqlitePool, id: Uuid) -> Result<Document> {
        ...
        Ok(Document {
            ...
            folder_id: erp_core::parse_uuid_opt(row.try_get::<Option<&str>, _>("folder_id")?, "folder_id")?,
            ...
            author_id: erp_core::parse_uuid_opt(row.try_get::<Option<&str>, _>("author_id")?, "author_id")?,
            owner_id: erp_core::parse_uuid_opt(row.try_get::<Option<&str>, _>("owner_id")?, "owner_id")?,
            checked_out_by: erp_core::parse_uuid_opt(row.try_get::<Option<&str>, _>("checked_out_by")?, "checked_out_by")?,
            checked_out_at: erp_core::parse_datetime_opt(row.try_get::<Option<&str>, _>("checked_out_at")?, "checked_out_at")?,
            approved_by: erp_core::parse_uuid_opt(row.try_get::<Option<&str>, _>("approved_by")?, "approved_by")?,
            approved_at: erp_core::parse_datetime_opt(row.try_get::<Option<&str>, _>("approved_at")?, "approved_at")?,
            published_at: erp_core::parse_datetime_opt(row.try_get::<Option<&str>, _>("published_at")?, "published_at")?,
            expires_at: erp_core::parse_datetime_opt(row.try_get::<Option<&str>, _>("expires_at")?, "expires_at")?,
    ...
    async fn list_versions(&self, pool: &SqlitePool, document_id: Uuid) -> Result<Vec<DocumentVersion>> {
        ...
        for row in rows {
            versions.push(DocumentVersion {
                ...
                changed_by: erp_core::parse_uuid_opt(row.try_get::<Option<&str>, _>("changed_by")?, "changed_by")?,
                status: DocumentStatus::Draft,
            });
        }
        Ok(versions)
